...
<a
  href="https://www.google.com/maps?q=Haware+Fantasia+Business+Park+Sector+30A+Vashi+Navi+Mumbai"
  target="_blank"
  rel="noopener noreferrer"
  className="block hover:opacity-90 transition"
>
  <div className="flex items-start gap-1.5 md:gap-3 cursor-pointer">
    <MapPin size={8} className="text-primary-blue mt-0.5 md:size-5" />
    <span className="text-gray-400 text-[11px] md:text-sm leading-snug hover:underline">
