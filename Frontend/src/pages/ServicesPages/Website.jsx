...
const WebsiteDevelopment = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-white text-gray-900 overflow-hidden">
      ...
      <div className="md:hidden  w-full fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm z-50 py-3 px-4 shadow-sm border-b border-gray-200">
      ...
      <section id="home" className="pt-16 md:pt-20 pb-8 md:pb-10 px-4 md:px-0">
        <div className="md:max-w-full mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 md:gap-8">
            ...
            <div className={`w-full lg:w-1/2 ${isMobile ? 'order-1 mb-4' : ''} transition-all duration-1000 transform ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              <div className="relative group md:pr-12 lg:pr-24">
      ...
      <section id="about" className="py-8 md:py-12 px-4 md:px-0 bg-gradient-to-b from-white to-blue-50/30">
        <div className="md:max-w-full mx-auto">
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8 items-center md:px-12 lg:px-24">
      ...
      <section id="services" className="py-8 md:py-12 px-4 md:px-0">
        <div className="md:max-w-full mx-auto">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center mb-6 md:mb-8 animate-on-scroll">
            Our <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Development Services</span>
          </h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 md:px-12 lg:px-24">
      ...
      <section id="gallery" className="py-8 md:py-12 px-4 md:px-0 bg-gradient-to-b from-white to-blue-50/30">
        <div className="md:max-w-full mx-auto">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center mb-6 md:mb-8 animate-on-scroll">
            Our <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Work Gallery</span>
          </h2>
          
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 md:px-12 lg:px-24">
      ...
      <section className="py-8 md:py-12 px-4 md:px-0">
        <div className="md:max-w-full mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 md:px-12 lg:px-24">
