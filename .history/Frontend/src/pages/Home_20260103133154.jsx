...
// Update services array to include links
const services = [
  {
    title: 'Database Managed Services',
    description: 'Comprehensive database management, monitoring, and optimization services.',
  ...
  <motion.div
    ...
    className="group relative rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-xl md:hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 md:hover:-translate-y-2 overflow-hidden"
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <p className="text-white/90 mb-4 sm:mb-6 text-sm sm:text-base">{service.description}</p>
      
      <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
        {service.features.map((feature, idx) => (
          <li key={idx} className="flex items-center gap-2 sm:gap-3 text-white/90 text-sm sm:text-base">
            <div className="w-1 h-1 sm:w-2 sm:h-2 bg-white rounded-full flex-shrink-0"></div>
            <span>{feature}</span>
          </li>
        ))}
      </ul>
      ...
      <Link to={service.link}>
        <button className="text-white font-semibold flex items-center gap-1 sm:gap-2 group-hover:gap-2 sm:group-hover:gap-3 transition-all text-sm sm:text-base hover:text-blue-300">
  ...
  <div className="container mx-auto px-4 sm:px-6">
    <div className="max-w-4xl mx-auto text-center">
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 border border-gray-300 shadow-xl"
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          <Link to="/contact">
            <button className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-3 sm:px-8 sm:py-3.5 md:px-10 md:py-4 rounded-lg sm:rounded-xl font-bold hover:shadow-xl md:hover:shadow-2xl transition-all duration-300 hover:scale-105 transform flex items-center gap-2 text-sm sm:text-base md:text-lg">
              <Rocket className="w-4 h-4 sm:w-5 sm:h-5" />
              Start Your Project Today
              <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
            </button>
          </Link>
          {/* Uncomment if you have a portfolio page */}
          {/* <Link to="/portfolio">
            <button className="bg-transparent border border-gray-800 text-gray-800 px-6 py-3 sm:px-8 sm:py-3.5 md:px-10 md:py-4 rounded-lg sm:rounded-xl font-bold hover:bg-gray-50 transition-all duration-300 text-sm sm:text-base md:text-lg">
              View More Projects
            </button>
          </Link> */}
        </div>
