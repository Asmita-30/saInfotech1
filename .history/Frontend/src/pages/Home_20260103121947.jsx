...
const Home = () => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[100vh] overflow-hidden">
      ...
      {/* Final CTA Section */}
      <section className="py-10 sm:py-14 md:py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="container mx-auto px-4 sm:px-6">
