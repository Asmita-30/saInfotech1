...
const Bulksms = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 to-white py-8 md:py-12 px-4 md:px-0">
      {/* Hero Section */}
      <motion.div 
      ...
      >
        <div className="text-center md:px-12 lg:px-24">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4 md:mb-6">
            Bulk SMS Services by  <span className="text-blue-600 ">SA</span>  <span className="text-blue-600">Infotech</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mx-auto mb-8 md:mb-12">
      ...
      <motion.div 
        ...
        className="w-full"
      >
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-8 md:mb-16 md:px-12 lg:px-24">
          Our Comprehensive SMS Solutions
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 md:px-12 lg:px-24">
       ...
       {/* Animated Stats */}
          <motion.div 
            ...
            className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 w-full md:px-12 lg:px-24 mx-auto mb-8 md:mb-16"
          >
            {[
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12 md:px-12 lg:px-24">
          Why Choose Our Bulk SMS Services?
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 md:px-12 lg:px-24">
