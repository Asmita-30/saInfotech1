...
const WebsiteDevelopment = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-hidden">
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm z-50 py-3 px-4 shadow-sm border-b border-gray-200">
      ...
      <section id="contact" className="py-8 md:py-12 px-4 md:px-12 lg:px-24 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto bg-white rounded-xl md:rounded-2xl p-4 md:p-8 border border-gray-300 shadow-lg animate-on-scroll hover-card">
              ...
              <div>
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-xs md:text-sm">contact@sainfotech.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-bold text-sm md:text-base">Phone</h4>
                      <p className="text-gray-700 text-xs md:text-sm">+91 98765 43210</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-xs md:text-sm">123 Tech Park, Mumbai, India</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 md:mt-6">
                  <div className="flex space-x-3">
                    <div className="w-7 h-7 md:w-8 md:h-8 bg-black rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300">
                ...
                <form className="space-y-3 md:space-y-4">
                  <div>
                    <input 
                      ...
                      className="w-full bg-white border border-gray-300 rounded-lg px-3 md:px-4 py-2 text-sm md:text-base focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    <input 
                  ...
                  <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 md:px-6 py-2 md:py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-[1.02] shadow-md hover:shadow-lg text-sm md:text-base">
                    Send Message
                  </button>
                </form>
              </div>
      ...
      <footer className="py-4 md:py-6 px-4 border-t border-gray-300 bg-black text-white">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-2 mb-2 md:mb-0">
            <div className="w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full"></div>
