  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Hero Section */}
        {/* <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 shadow-xl mb-10">
              ...
              <div className="md:w-2/3 mb-8 md:mb-0">
                <div className="flex items-center mb-4">
                  <div className="p-3 rounded-xl bg-white/10 backdrop-blur-sm mr-4">
                    <FaDatabase className="text-4xl md:text-5xl text-blue-300" />
                  </div>
                  <div>
                    <h1 className="text-3xl md:text-5xl font-bold mb-2">Database Managed Services</h1>
                    <p className="text-xl text-blue-200">Professional database administration made simple & secure</p>
                  </div>
                </div>
                <p className="text-lg text-blue-100 max-w-3xl">
                  Let our certified experts handle your database infrastructure while you focus on your core business.
                </p>
              </div>
              <div className="md:w-1/3 flex justify-center">
                <div className="relative">
                  <div className="w-48 h-48 md:w-64 md:h-64 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 opacity-20 animate-pulse"></div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-5xl md:text-6xl mb-4">🚀</div>
                      <div className="text-xl font-bold">Scale with Confidence</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Stats Bar */}
          {/* <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-white/10 backdrop-blur-sm border-t border-white/20">
