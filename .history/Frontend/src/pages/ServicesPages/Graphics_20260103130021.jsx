...
const Graphics = () => {
  ...
  return (
    <div className="min-h-screen bg-white-to-b from-gray-900 to-black text-white overflow-hidden">
      {/* Header */}
      <header className="relative py-8 md:py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-black-300 text-center max-w-4xl mx-auto">
      ...
      <footer className="py-8 px-4 md:px-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400 mb-2">
            © {new Date().getFullYear()} Infotech Graphics Solutions. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
            Using React.js, Tailwind CSS, and modern graphics technologies.
          </p>
        </div>
      </footer>
