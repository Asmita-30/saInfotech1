        ...
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-3 mb-4 md:mb-0">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Digital Solutions & Software Development</p>
            </div>
          </div>
          ...
          <nav className="flex space-x-1 bg-gray-100 p-1 rounded-xl">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${activeTab === 'digital-marketing' 
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${activeTab === 'software-dev' 
                ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-md' 
                : 'text-gray-700 hover:bg-gray-200'}`}
            >
              <div className="flex items-center">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-16 text-center animate-fade-in">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-10">
            SA Infotech provides cutting-edge digital marketing solutions and custom software development 
            to help your business thrive in the digital age.
          </p>
          
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center">
              Get Started <ArrowRight size={20} className="ml-2" />
            </button>
            <button className="px-8 py-3 bg-white text-gray-800 font-semibold rounded-xl shadow-lg hover:shadow-xl border border-gray-200 transform hover:-translate-y-1 transition-all duration-300">
              View Our Portfolio
            </button>
          </div>
        </section>
