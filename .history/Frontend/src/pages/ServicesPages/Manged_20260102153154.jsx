        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="ml-3 text-2xl font-bold text-gray-800">SA Infotech</h1>
            </div>
      ...
      <main className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mt-24 mb-12">
          <div className="text-center mb-10">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Trusted by Industry Leaders</h3>
            <p className="text-gray-600 max-w-2xl mx-auto">Our managed services have helped businesses of all sizes achieve their technology goals</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {name: "Sarah Johnson", company: "TechNova Inc.", quote: "SA Infotech transformed our IT infrastructure. Our uptime improved by 40%."},
              {name: "Michael Chen", company: "Global Finance Corp", quote: "Their proactive monitoring saved us from a major security breach."},
              {name: "Priya Sharma", company: "Retail Solutions Ltd", quote: "Cost-effective and reliable - exactly what our growing business needed."}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="flex items-center">
                ...
                <h2 className="ml-3 text-2xl font-bold">SA Infotech</h2>
              </div>
              <p className="text-gray-400 mt-2">Your trusted partner in managed IT services</p>
            </div>
            
            <div className="text-center md:text-right">
              <p className="text-gray-400">© 2023 SA Infotech. All rights reserved.</p>
              <p className="text-gray-400 mt-2">contact@sainfotech.com | +1 (555) 123-4567</p>
            </div>
          </div>
        </div>
      </footer>
