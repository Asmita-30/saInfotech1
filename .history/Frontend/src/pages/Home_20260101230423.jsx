...
const Home = () => {
  ...
  const testimonials = [
    {
      name: 'John Smith',
      role: 'CEO, TechCorp',
      content: 'Excellent service! Our website traffic increased by 300% after working with this team. The database managed services have improved our system performance dramatically.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Professional team with exceptional attention to detail. Their digital marketing strategies helped us achieve record sales this quarter. Highly recommended!',
      rating: 5,
    ...
    },
    {
      name: 'Michael Chen',
      role: 'CTO, StartupXYZ',
      content: 'Their mobile app development expertise helped us launch successfully in both iOS and Android stores. The on-site resource support was invaluable during critical phases.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Outstanding database management services. Our system performance improved by 40% after implementing their optimization solutions. The 24/7 support is exceptional.',
      rating: 5,
    ...
    },
    {
      name: 'Robert Wilson',
      role: 'IT Director',
      content: 'The managed services team is extremely responsive and proactive. Our IT infrastructure has never been more stable. Their bulk SMS service helped us reach 95% more customers.',
      rating: 5,
  ...
  return (
    <div className="min-h-screen">
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                    {project.category}
                  </div>
                ...
                <div className="p-6">
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.map((tech, idx) => (
                      <span key={idx} className="px-3 py-1 bg-gradient-to-r from-blue-50 to-cyan-50 text-blue-600 rounded-full text-sm font-medium">
                        {tech}
                      </span>
                    ))}
                  </div>
      ...
      {/* Trusted Partners Section - Moved Up */}
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full">
          ...
          {/* Enhanced Logo Grid with Background */}
          <div className="relative bg-gradient-to-br from-white to-blue-50 rounded-3xl p-8 md:p-12 shadow-xl mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 relative z-10">
              {clientLogos.map((logo, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 h-32 flex items-center justify-center border border-blue-100">
                    <div className="relative w-full h-10 flex items-center justify-center">
                      <img
                        src={logo}
                        alt={`Client ${index + 1}`}
                        className="max-w-full max-h-10 object-contain grayscale group-hover:grayscale-0 transition-all duration-300"
                      />
                    </div>
                  </div>
            ...
            <div className="text-center mt-12">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-3 rounded-full">
                <GlobeIcon2 className="w-5 h-5" />
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-600 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 mb-4 px-6 py-3 bg-white/20 backdrop-blur-sm rounded-full">
              <Heart className="w-5 h-5 text-white" />
              <span className="text-white font-semibold">CUSTOMER REVIEWS</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              What Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-amber-200">Clients Say</span>
            </h2>
          ...
          <div className="relative max-w-6xl mx-auto">
            {/* Background Elements */}
            <div className="absolute -top-20 -left-20 w-64 h-64 bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-gradient-to-r from-cyan-400/20 to-blue-400/20 rounded-full blur-3xl"></div>
            
            <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                      ...
                      <div className="lg:w-1/3 text-center lg:text-left">
                        <div className="relative inline-block">
                          <img
                            ...
                            className="w-32 h-32 rounded-full border-4 border-white/30 shadow-2xl mx-auto lg:mx-0"
                          />
                          <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-yellow-400 to-amber-500 text-white p-2 rounded-full">
                            <Star className="w-5 h-5 fill-current" />
                          </div>
                        </div>
                        <div className="mt-6">
                          <h4 className="text-2xl font-bold text-white">{testimonial.name}</h4>
                          <p className="text-blue-100 font-medium">{testimonial.role}</p>
                        ...
                        <div className="mt-4 inline-flex items-center gap-2 text-blue-100 bg-white/10 px-4 py-2 rounded-full">
                      ...
                      <div className="lg:w-2/3">
                        ...
                        <div className="mt-8 flex items-center justify-between">
                          <div className="flex items-center gap-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-400/30 px-4 py-2 rounded-full">
                            <ShieldCheck className="w-5 h-5 text-green-300" />
                            <span className="text-green-100 font-semibold">Verified Customer</span>
                          </div>
                  ...
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      testimonialIndex === index 
                        ? 'bg-gradient-to-r from-yellow-300 to-amber-400 w-8' 
              ...
              <button
                ...
                className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 p-3 rounded-full text-white transition-all duration-300 backdrop-blur-sm border border-white/30"
              >
                <ChevronLeft className="w-6 h-6" />
              </button>
              <button
                onClick={() => setTestimonialIndex((prev) => (prev + 1) % testimonials.length)}
                className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 p-3 rounded-full text-white transition-all duration-300 backdrop-blur-sm border border-white/30"
              >
                <ChevronRight className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-blue-100 font-medium">5-Star Reviews</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">95%</div>
                <div className="text-blue-100 font-medium">Repeat Business</div>
              </div>
              <div className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-r from-blue-600/20 to-cyan-500/20 rounded-3xl p-8 md:p-12 border border-white/10"
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/contact">
                  <button className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-10 py-4 rounded-xl font-bold hover:shadow-2xl transition-all duration-300 hover:scale-105 transform flex items-center gap-3">
                ...
                <Link to="/portfolio">
                  <button className="bg-transparent border-2 border-white/20 text-white px-10 py-4 rounded-xl font-bold hover:bg-white/10 transition-all duration-300">
                    View More Projects
                  </button>
                </Link>
              </div>
