// pages/Services.jsx - केवल allServices array update करें
...
const Services = () => {
  const allServices = [
    {
      ...
      // link remove कर दें क्योंकि अब ServiceCard में automatically generate हो रहा है
    },
    {
  ...
  // बाकी सब code वही रहेगा जो आपने दिया है...
  return (
    <div className="py-12">
