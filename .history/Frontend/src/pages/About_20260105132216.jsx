...
import ceoImage from "../assets/CEO.jpg"; // adjust path if needed
...
const ceoInfo = {
  ...
  <div className="relative w-full lg:w-[85%] bg-white rounded-2xl shadow-2xl p-4">
    ...
    <div className="absolute top-6 left-6">
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-5 py-2.5 rounded-xl shadow-lg inline-flex items-center gap-2">
