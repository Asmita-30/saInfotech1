          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <Link to="/contact">
                  <button className="bg-gradient-to-r text-white px-6 py-3 sm:px-8 sm:py-3.5 md:px-10 md:py-4 rounded-lg sm:rounded-xl font-bold hover:shadow-xl md:hover:shadow-2xl transition-all duration-300 hover:scale-105 transform flex items-center gap-2 text-sm sm:text-base md:text-lg">
