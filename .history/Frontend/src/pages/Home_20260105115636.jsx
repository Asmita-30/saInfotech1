          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group relative rounded-xl sm:rounded-xl p-2 sm:p-2 md:p-4 shadow-md hover:shadow-xl md:hover:shadow-lg transition-all duration-300 hover:-translate-y-1 md:hover:-translate-y-1 overflow-hidden cursor-pointer"
