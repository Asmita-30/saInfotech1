      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-14">
            <div className="inline-flex items-center px-6 py-3 bg-indigo-50 rounded-full mb-6">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our professionals bring years of experience to deliver scalable
            ...
            {teamMembers.map((member) => (
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-10">
                  <span className="bg-indigo-700 text-white px-3 py-1.5 rounded-lg text-xs font-bold">
                    {member.experience}
                  </span>
                </div>
                ...
                <div className="p-6">
                  ...
                  {/* Button */}
                  <button className="w-full py-3 bg-white border border-gray-200
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="relative z-10 p-12 md:p-16 text-center text-white">
              ...
              <p className="text-lg text-white/85 mb-8 max-w-2xl mx-auto">
                Partner with SA Infotechs to build scalable and future-ready
                digital solutions.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="px-10 py-4 border border-white
                text-white font-semibold rounded-xl">
                  Schedule a Call
                </button>
              </div>
