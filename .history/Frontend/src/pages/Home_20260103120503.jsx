...
<section className="relative h-[60vh] sm:h-[70vh] lg:h-[80vh] overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              <div className="w-8 sm:w-12 h-1 bg-blue-500"></div>
              <span className="text-blue-400 font-semibold text-sm sm:text-base">WELCOME TO OUR COMPANY</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mb-6 sm:mb-8">
              {slide.features.map((feature, idx) => (
                <div key={idx} className="flex items-center gap-2 text-white/80 text-sm sm:text-base">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <Link to="/contact">
                <button className="bg-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center gap-2 hover:scale-105 transform transition-transform text-sm sm:text-base">
                  Get Started <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
                </button>
              </Link>
              <Link to="/about">
                <button className="bg-transparent border-2 border-white/30 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors text-sm sm:text-base">
                  Learn More
                </button>
              </Link>
            </div>
  ...
  <button
    ...
    className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 p-1.5 sm:p-2 rounded-full text-white transition-colors backdrop-blur-sm"
  >
    <ChevronLeft className="w-4 h-4 sm:w-6 sm:h-6" />
  </button>
  <button
    onClick={() => setCurrentSlide((prev) => (prev + 1) % 3)}
    className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 p-1.5 sm:p-2 rounded-full text-white transition-colors backdrop-blur-sm"
  >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="inline-flex items-center gap-3 mb-6 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full"
            >
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-8">
              {clientLogos.slice(0, 6).map((client, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 h-32 flex flex-col items-center justify-center border border-gray-200">
            ...
            {/* Center Stats */}
            <div className="mt-16 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-3xl p-8 md:p-12 shadow-2xl">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              ...
              <span className="text-white font-semibold text-lg">CUSTOMER REVIEWS</span>
            </motion.div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
          ...
          <div className="relative max-w-6xl mx-auto">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-3">
                  ...
                  <div className="bg-gradient-to-br from-blue-600 to-cyan-500 p-8 md:p-12 text-white">
                    <div className="flex flex-col items-center text-center h-full justify-center">
                      ...
                      <h3 className="text-2xl font-bold mb-2">{testimonials[testimonialIndex].name}</h3>
                      <p className="text-blue-100 font-medium mb-1">{testimonials[testimonialIndex].role}</p>
                      ...
                      <div className="space-y-3 mt-6">
                        <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                          ...
                          <span>{testimonials[testimonialIndex].date}</span>
                        </div>
                        <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                        ...
                        <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                          ...
                          <span>{testimonials[testimonialIndex].project}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-2 p-8 md:p-12">
                    <div className="h-full flex flex-col justify-center">
                      <div className="relative mb-8">
                        ...
                        <p className="text-2xl md:text-3xl font-light text-gray-600 leading-relaxed italic pl-8">
                      ...
                      <div className="mt-8 pt-8 border-t border-gray-200">
                        <div className="flex flex-wrap gap-4">
                          <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg">
                            ...
                            <span className="font-semibold text-green-700">Project Success</span>
                          </div>
                          <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg">
                            <TrendingUp className="w-5 h-5 text-blue-500" />
                            <span className="font-semibold text-blue-700">Positive ROI</span>
                          </div>
                          <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
                            ...
                            <span className="font-semibold text-purple-700">Satisfied Client</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex items-center justify-center mt-12 space-x-8">
              <button
                ...
                className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105"
              >
              ...
              <div className="text-center">
                ...
                <div className="text-gray-500 text-sm">Customer Reviews</div>
              </div>
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <div className="text-gray-700 font-semibold">5-Star Reviews</div>
              </div>
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                <div className="text-4xl font-bold text-amber-600 mb-2">95%</div>
                <div className="text-gray-700 font-semibold">Repeat Business</div>
              </div>
            </div>
          </div>
        </div>
