  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="text-center mb-14">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto">
        Our professionals bring years of experience to deliver scalable and
      ...
      {teamMembers.map((member, index) => (
        ...
        >
          ...
          <div className="relative h-64 overflow-hidden">
            ...
            from-black/30 via-black/10 to-transparent"></div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="text-indigo-700 font-semibold mb-3 flex items-center">
            ...
            {/* View Profile Button */}
            <button
              className="w-full py-3 bg-white border border-gray-200
    ...
    <div className="text-center mt-10">
      <button
        className="group inline-flex items-center px-7 py-3.5
...
<section className="py-0">
  <div className="max-w-6xl mx-auto px-4">
    <div className="relative rounded-3xl overflow-hidden shadow-xl">
      ...
      from-blue-700 via-indigo-700 to-purple-700"></div>

      {/* Subtle Texture Image */}
      <div className="absolute inset-0 
      bg-[url('https://images.unsplash.com/photo-1550684376-efcbd6e3f031?w=1200&q=80')]
      bg-cover bg-center opacity-5"></div>

      {/* Content */}
      <div className="relative z-10 p-12 md:p-16 text-center text-white">
        
        <Zap className="w-14 h-14 mx-auto mb-6 text-yellow-300 opacity-90" />
        ...
        <p className="text-lg md:text-xl text-white/85 mb-10 max-w-2xl mx-auto">
          Partner with SA Infotechs to build scalable, secure and future-ready
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          {/* Primary CTA */}
          <button className="px-10 py-4 bg-white text-indigo-700 
          ...
          border border-white/70 text-white font-semibold rounded-xl
