...
<div className="relative h-96 rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full">
                    ...
                    <a
  href="https://www.google.com/maps?q=Haware+Fantasia+Business+Park+Vashi"
  target="_blank"
  rel="noopener noreferrer"
>
  <div className="relative h-96 rounded-2xl overflow-hidden cursor-pointer">
    <iframe
      title="SA Infotech Location"
      src="https://www.google.com/maps?q=Haware%20Fantasia%20Business%20Park%20Vashi&output=embed"
    ...
    ></iframe>
                    ...
                    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-2xl max-w-md">
                      ...
                      <p className="text-gray-600 mb-2"> S-57, Haware Fantasia Business Park, Sector 30A, Vashi,
    Navi Mumbai – 400703</p>
                    </div>
                  </div>
                </div>
              </div>
