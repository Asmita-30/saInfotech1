...
const Navbar = () => {
  ...
  // Mobile service click handler - FIXED VERSION
  const handleMobileServiceClick = (e, path) => {
    e.preventDefault();
    setIsOpen(false);
    setServiceOpen(false);
    setTimeout(() => {
            ...
            <div className="p-4 space-y-1">
                ...
                {serviceOpen && (
                  <div className="ml-4 mt-3 space-y-2 max-h-[60vh] overflow-y-auto pr-2 animate-fade-in">
                    {services.map((service) => (
                      <div
                        key={service.name}
                        onClick={(e) => handleMobileServiceClick(e, service.path)}
              ...
              <div className="mt-6 p-4">
                <div
                  ...
                  className="block w-full py-3 px-4 text-center rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-medium transition-all duration-300 transform hover:scale-[1.02] active:scale-95 shadow-lg shadow-blue-500/25 cursor-pointer"
                >
