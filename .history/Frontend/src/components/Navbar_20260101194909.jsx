    ...
    <nav className="bg-dark-bg text-white sticky top-0 z-50 shadow-lg">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8 relative">
          ...
          >
            ...
            {serviceOpen && (
              <div className="absolute top-10 left-0 w-64 bg-dark-bg border border-gray-700 rounded-lg shadow-lg max-h-56 overflow-y-auto">
      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          {serviceOpen && (
            <div className="pl-4 max-h-48 overflow-y-auto space-y-3">
              {services.map((service) => (
                <Link
                  key={service.name}
                  to={service.path}
