          ...
          <Link to="/" className="flex items-center space-x-3 group cursor-pointer relative">
            <div className="relative">
              ...
              <img 
                ...
                className="h-25 w-auto relative transform group-hover:scale-105 transition-all duration-300 group-hover:rotate-2 group-hover:drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]" 
              />
            </div>
