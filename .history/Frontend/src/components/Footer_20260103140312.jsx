...
const Footer = () => {
  ...
  const socialLinks = [
    {
      Icon: Facebook,
      link: 'https://www.facebook.com/your-facebook-page', // Replace with actual link
      label: 'Facebook'
    },
    {
      Icon: Twitter,
      link: 'https://twitter.com/your-twitter', // Replace with actual link
      label: 'Twitter'
    },
    {
      Icon: Linkedin,
      link: 'https://www.linkedin.com/company/sa-infotech', // Replace with actual link or keep this
      label: 'LinkedIn'
    },
    {
      Icon: Instagram,
      link: 'https://www.instagram.com/your-instagram', // Replace with actual link
      label: 'Instagram'
    },
  ];
