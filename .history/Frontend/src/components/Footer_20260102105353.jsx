          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">+91-8104012686</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin size={20} className="text-primary-blue" />
                <span className="text-gray-400">S-57, Haware Fantasia Business Park, 203, Sector 30A, Vashi, Navi Mumbai, Maharashtra 400703</span>
              </div>
            </div>
          </div>
        </div>
