...
import SoftwareDevelopment from './pages/ServicesPages/Software';
import  MobileApplication from './pages/ServicesPages/Mobile'
function App() {
  return (
    <MainLayout>
      <Routes>
...
<Route path="/services/Software" element={<MobileApplication/>}/>
